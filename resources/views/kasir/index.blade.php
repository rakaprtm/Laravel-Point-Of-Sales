            ...
            <div class="flex flex-row w-auto flex-shrink-0 pl-4 pr-2 py-4">
                ...
                >
                  ...
                  'bg-cyan-300 shadow-lg text-white': activeMenu === 'pos',
                        ...
                        <li>
                            <a href="/stock" class="flex items-center group relative">
                                <span
                                ...
                                <span
                                class="absolute left-16 opacity-0 group-hover:opacity-100 transition-opacity bg-cyan-400 text-white text-sm px-2 py-1 rounded-lg"
                                >
                                Stock
                                </span>
                            </a>
                        ...
                        >
                            ...
                            >
                                <path
                                    ...
                                    stroke-linejoin="round"
                                    stroke-width="2"
                                    d="M3 12l2-2m0 0l7-7 7 7M13 5v6h6l-8 8-8-8h6V5z"
                                />
                            </svg>
                        </span>
                        <span
                            class="absolute left-16 opacity-0 group-hover:opacity-100 transition-opacity bg-cyan-400 text-white px-3 py-1 rounded-lg text-sm"
                        >
                            Dashboard
                        </span>
                    </a>
    ...
    <a href="/logout" class="flex items-center">
        ...
        >
            ...
            <div class="flex-grow flex">
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        />
                                        <div
                                            class="flex pb-3 px-3 text-sm -mt-3"
                                        >
                                            <p
                ...
                >
                    <div
                        class="bg-white rounded-3xl flex flex-col h-full shadow"
                    >
                        <!-- empty cart -->
                        <div
                        ...
                        >
                            <div class="h-16 text-center flex justify-center">
                                <div
                                    class="pl-8 text-left text-lg py-4 relative"
                                >
                                    <!-- cart icon -->
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div
                                    class="flex-grow px-8 text-right text-lg py-4 relative"
                                >
                                    <!-- trash button -->
                                    <button
                                        x-on:click="clear()"
                            ...
                            <div class="flex-1 w-full px-4 overflow-auto">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div class="py-1">
                                            <div
                                                class="w-28 grid grid-cols-3 gap-2 ml-2"
                                            >
                                                <button
                        ...
                        >
                            <div
                                class="flex mb-3 text-lg font-semibold text-blue-gray-700"
                            >
                                <div>TOTAL</div>
                                <div
                    ...
                    >
                        <div class="text-center">
                            <img
                                ...
                                src="{{ asset('img/resto.png') }}"
                                alt="Tailwind POS"
                                class="mb-3 w-8 h-8 inline-block"
                            />
                            <h2 class="text-xl font-semibold">RESTO🍔RASI</h2>
                            <p>Central Jakarta</p>
                        </div>
